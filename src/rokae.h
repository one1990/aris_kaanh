...
namespace rokae
{
	...
	constexpr double ea_k = 845.26, ea_b = 57.047, ea_offset = 3.65, ea_index = 6;  //电缸电流换算压力的系数，ea_k表示比例系数，ea_b表示截距，ea_offset表示重力影响量，ea_index表示电流扭矩系数=额定扭矩*6.28*减速比/导程/1000//
