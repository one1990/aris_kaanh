...
{ 
	...
	double CoefParasJointInv[JointReduceDim* JointGroupDim] = { 0 };
        ...
        void LoadRLS(const double *positionList, const double *sensorList, double *estParas, double *StatisError);
        void LoadParasExt(const double *dEst, double *Load);
