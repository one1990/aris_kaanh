...
int main(int argc, char** argv)
 {
	...
	odom_trans2.transform.rotation = tf::createQuaternionMsgFromRollPitchYaw(0.0, 0, 0.0);
        ...
        odom_trans3.transform.translation.z = 0  ;  
        //odom_trans.transform.rotation = tf::createQuaternionMsgFromYaw(angle);  
	odom_trans3.transform.rotation = tf::createQuaternionMsgFromRollPitchYaw(0.0, 0, 0.0);
        ...
        //odom_trans.transform.rotation = tf::createQuaternionMsgFromYaw(angle);  
	odom_trans4.transform.rotation = tf::createQuaternionMsgFromRollPitchYaw(0.0, 0, 0.0);
        ...
        //odom_trans.transform.rotation = tf::createQuaternionMsgFromYaw(angle);  
	odom_trans5.transform.rotation = tf::createQuaternionMsgFromRollPitchYaw(0.0, 0, 0.0);
        ...
        //odom_trans.transform.rotation = tf::createQuaternionMsgFromYaw(angle);  
	odom_trans6.transform.rotation = tf::createQuaternionMsgFromRollPitchYaw(0.0, 0, 0.0);

        odom_trans7.header.stamp = ros::Time::now();  
        odom_trans7.transform.translation.x = 0;  
        odom_trans7.transform.translation.y = 0;  
        odom_trans7.transform.translation.z = 0  ;  
        //odom_trans.transform.rotation = tf::createQuaternionMsgFromYaw(angle);  
